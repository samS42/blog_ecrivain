...
<div class="col-md-offset-4 col-md-4 col-md-offset-4">
	...
	<div id="content-list-posts" class="col-md-offset-3 col-md-6 col-md-offset-3">
		...
		<form  method="POST" action="/tests/blog_mvc/tests/POO/index.php?action=addComment&id=<?= $db2['id'] ?>">
			<div class="form-group col-md-6"><label for="pseudo">Pseudo: </label><input type="text" name="pseudo" id="pseudo" class="form-control"></div>
			...
			<div id="btn" class="form-group"><input type="submit" class="btn btn-success" /></div>
		</form>
		</div>
		</div>
	</div>
