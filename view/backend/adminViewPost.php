...
<a href="/tests/blog_mvc/tests/POO/index.php?action=displayTitles" class="btn btn-success btn-block">Retour aux billets</a>
<a href="/tests/blog_mvc/tests/POO/index.php" class="btn btn-default btn-block">Retour au site</a>
...
<p>
	<?= $display['title'] ?>
	<?= $display['date_creation'] ?><br/>
	<?= $display['content'] ?><?php $display['id']; ?>
</p>

<?php $content = ob_get_clean(); ?>

<?php $title_2 = '<h2>Commentaires</h2>' ?>
